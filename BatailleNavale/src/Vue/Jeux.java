        ...
        for (int i = 0 ; i < 16 ; i++) {
            ...
            do
                    ...
                    if (compteur % 2 == 1) 
                            ...
                            do
                                    {
                                    ligneDevinee = fonction.abscisse() ;	
                                    colonneDevinee = fonction.ordonnee() ;
                                    }
            ...
            if (toucheA == 17) 
                    {
                    fonction.SecondPrint(grille, grilleCachee) ;
                    System.out.println(nomDuJoueur + " : vous avez gagne") ;

                    }
            else
                    {
                    fonction.SecondPrint(grille, grilleCachee) ;
                    System.out.println(nomDuJoueur + " : vous avez perdu") ;
                    }	
